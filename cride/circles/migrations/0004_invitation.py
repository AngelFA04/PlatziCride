# Generated by Django 3.1.2 on 2020-11-18 01:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('circles', '0003_auto_20201104_2000'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('used_by', models.ForeignKey(help_text='User that used the code to enter the circlo', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='used_by', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
